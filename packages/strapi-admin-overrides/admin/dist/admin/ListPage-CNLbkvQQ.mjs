...
import { n as useFetchClient, b as Layouts, S as SearchInput, C as ConfirmDialog } from './index-Ci1UPn5H.mjs';
import { b as useTypedSelector, P as Page, e as useAPIErrorHandler, a as useNotification, n as useQueryParams, k as useRBAC } from './Theme-BneL-jOW.mjs';
import { u as useAdminRoles } from './useAdminRoles-C81rIrt0.mjs';
import { s as selectAdminPermissions } from './selectors-DSWA1PgN.mjs';
import { c as isFetchError } from './admin-DOzK8yjX.mjs';
  ...
  return /* @__PURE__ */ jsxs(Page.Main, { children: [
    ...
    canRead && /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsxs(
      Table,
      {
        colCount,
        rowCount,
        footer: canCreate ? /* @__PURE__ */ jsx(TFooter, { cursor: "pointer", onClick: handleNewRoleClick, icon: /* @__PURE__ */ jsx(Plus, {}), children: formatMessage({
          id: "Settings.roles.list.button.add",
          defaultMessage: "Add new role"
        }) }) : null,
        children: [
...
//# sourceMappingURL=ListPage-CNLbkvQQ.mjs.map
