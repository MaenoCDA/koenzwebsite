...
import { c as useTracking, t as capitalise, m as useGuidedTour, u as useAuth, P as Page } from './Theme-BneL-jOW.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-BsXfUEzd.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-DFJpYpi6.mjs.map
