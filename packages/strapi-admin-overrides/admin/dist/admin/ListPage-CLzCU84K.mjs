...
import { b as Layouts, C as ConfirmDialog } from './index-Ci1UPn5H.mjs';
import { b as useTypedSelector, P as Page, e as useAPIErrorHandler, a as useNotification, k as useRBAC } from './Theme-BneL-jOW.mjs';
...
const ListPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxs(Page.Main, { "aria-busy": isLoading, children: [
      /* @__PURE__ */ jsx(
        Layouts.Header,
        {
          ...
          primaryAction: canCreate && !isLoading && /* @__PURE__ */ jsx(LinkButton, { tag: NavLink, startIcon: /* @__PURE__ */ jsx(Plus, {}), variant: "default", to: "create", size: "S", children: formatMessage({
      ...
      /* @__PURE__ */ jsx(Layouts.Content, { children: numberOfWebhooks > 0 ? /* @__PURE__ */ jsxs(
        Table,
        {
          colCount: 5,
            ...
            /* @__PURE__ */ jsx(Tbody, { children: webhooks?.map((webhook) => /* @__PURE__ */ jsxs(
              Tr,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Td, { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsx(Flex, { children: /* @__PURE__ */ jsx(
                    Switch,
                    {
        ...
        EmptyStateLayout,
        {
          ...
          action: canCreate ? /* @__PURE__ */ jsx(LinkButton, { variant: "secondary", startIcon: /* @__PURE__ */ jsx(Plus, {}), tag: NavLink, to: "create", children: formatMessage({
            id: "Settings.webhooks.list.button.add",
            defaultMessage: "Create new webhook"
          }) }) : null
        }
    ...
    /* @__PURE__ */ jsx(Dialog.Root, { open: showModal, onOpenChange: setShowModal, children: /* @__PURE__ */ jsx(ConfirmDialog, { onConfirm: confirmBulkDelete }) })
  ] });
};
const DeleteActionButton = ({ onDelete }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Dialog.Root, { open: showModal, onOpenChange: setShowModal, children: /* @__PURE__ */ jsx(
      ConfirmDialog,
      {
        onConfirm: (e) => {
          e?.stopPropagation();
...
//# sourceMappingURL=ListPage-CLzCU84K.mjs.map
