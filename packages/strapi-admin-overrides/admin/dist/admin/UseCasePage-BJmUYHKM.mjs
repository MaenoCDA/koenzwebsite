...
import { P as PrivateRoute } from './PrivateRoute-CDN08Xre.mjs';
import { U as UnauthenticatedLayout, L as LayoutContent, a as Logo } from './index-Ci1UPn5H.mjs';
import { a as useNotification, u as useAuth } from './Theme-BneL-jOW.mjs';
  ...
  return /* @__PURE__ */ jsx(UnauthenticatedLayout, { children: /* @__PURE__ */ jsxs(Main, { labelledBy: "usecase-title", children: [
    /* @__PURE__ */ jsx(LayoutContent, { children: /* @__PURE__ */ jsxs("form", { onSubmit: (e) => handleSubmit(e, false), children: [
      /* @__PURE__ */ jsxs(Flex, { direction: "column", paddingBottom: 7, children: [
        /* @__PURE__ */ jsx(Logo, {}),
        /* @__PURE__ */ jsx(Box, { paddingTop: 6, paddingBottom: 1, width: `25rem`, children: /* @__PURE__ */ jsx(Typography, { textAlign: "center", variant: "alpha", tag: "h1", id: "usecase-title", children: formatMessage({
          id: "Usecase.title",
          defaultMessage: "Tell us a bit more about yourself"
        }) }) })
      ] }),
      /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
        /* @__PURE__ */ jsxs(Field.Root, { name: "usecase", children: [
          /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
            id: "Usecase.input.work-type",
            defaultMessage: "What type of work do you do?"
          }) }),
          /* @__PURE__ */ jsx(SingleSelect, { onChange: (value) => setRole(value), value: role, children: options.map(({ intlLabel, value }) => /* @__PURE__ */ jsx(SingleSelectOption, { value, children: formatMessage(intlLabel) }, value)) })
        ] }),
        isOther && /* @__PURE__ */ jsxs(Field.Root, { name: "other", children: [
          /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({ id: "Usecase.other", defaultMessage: "Other" }) }),
          /* @__PURE__ */ jsx(TextInput, { value: otherRole, onChange: (e) => setOtherRole(e.target.value) })
        ] }),
    ...
    /* @__PURE__ */ jsx(Flex, { justifyContent: "center", children: /* @__PURE__ */ jsx(Box, { paddingTop: 4, children: /* @__PURE__ */ jsx(
      TextButton,
      {
...
const PrivateUseCasePage = () => {
  return /* @__PURE__ */ jsx(PrivateRoute, { children: /* @__PURE__ */ jsx(UseCasePage, {}) });
};

export { PrivateUseCasePage, UseCasePage, options };
//# sourceMappingURL=UseCasePage-BJmUYHKM.mjs.map
