...
import { Flex, Portal, FocusTrap, IconButton, Box, Button, Typography, LinkButton, VisuallyHidden, Badge, Tooltip, AccessibleIcon, Menu, Avatar, useCollator, Divider, Popover, SkipToContent } from '@strapi/design-system';
...
import { Cross, ArrowRight, SignOut, Lightning, Play, Message, Question, Book, PaperPlane, House, ShoppingCart, Cog } from '@strapi/icons';
import get from 'lodash/get';
import { styled } from 'styled-components';
import { m as useGuidedTour, c as useTracking, r as useConfiguration, u as useAuth, p as useAppInfo, q as useStrapiApp, P as Page, b as useTypedSelector, A as AppInfoProvider } from './Theme-BneL-jOW.mjs';
import { L as LAYOUT_DATA, V as VerticalDivider, S as STATES, N as Number$1 } from './Ornaments-BFThxr2U.mjs';
import { g as getDisplayName, h as hashAdminUserEmail } from './users-8N93LH7R.mjs';
import { N as NpsSurvey } from './index-Ci1UPn5H.mjs';
import { produce } from 'immer';
import set from 'lodash/set';
import { P as PrivateRoute } from './PrivateRoute-CDN08Xre.mjs';
import cloneDeep from 'lodash/cloneDeep';
import { u as useOnce } from './useOnce-NHeEacbN.mjs';
import { d as useInformationQuery } from './admin-DOzK8yjX.mjs';
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ jsx(Popover.Root, { onOpenChange: setIsOpen, children: /* @__PURE__ */ jsxs(Box, { position: "fixed", bottom: 2, right: 2, children: [
    /* @__PURE__ */ jsx(Popover.Trigger, { children: /* @__PURE__ */ jsx(
      HelperButton,
      {
        ...
        children: /* @__PURE__ */ jsx(Icon, { fill: "buttonNeutral0" })
      }
    ) }),
...
//# sourceMappingURL=AuthenticatedLayout-50nPNzad.mjs.map
