...
import { e as errorsTrads, F as Form, b as Layouts, M as MemoizedInputRenderer } from './index-Ci1UPn5H.mjs';
import { b as useTypedSelector, c as useTracking, a as useNotification, d as useTypedDispatch, e as useAPIErrorHandler, u as useAuth, f as useUpdateMeMutation, g as useIsSSOLockedQuery, P as Page, s as setAppTheme } from './Theme-BneL-jOW.mjs';
import { i as isBaseQueryError } from './admin-DOzK8yjX.mjs';
import { g as getDisplayName } from './users-8N93LH7R.mjs';
import { C as COMMON_USER_SCHEMA } from './validation-B-0tldzN.mjs';
    ...
    /* @__PURE__ */ jsx(
      Form,
      {
        ...
        children: ({ isSubmitting, modified }) => /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx(Box, { paddingBottom: 10, children: /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
            /* @__PURE__ */ jsx(UserInfoSection, {}),
            !hasLockedRole && /* @__PURE__ */ jsx(PasswordSection, {}),
            /* @__PURE__ */ jsx(PreferencesSection, { localeNames })
          ] }) }) })
        ] })
      }
    )
  ...
  return /* @__PURE__ */ jsx(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
        ...
        ].map((row, index) => /* @__PURE__ */ jsx(Grid.Root, { gap: 5, children: row.map(({ size, ...field }) => /* @__PURE__ */ jsx(Grid.Item, { col: size, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsx(MemoizedInputRenderer, { ...field }) }, field.name)) }, index))
      ] })
    }
  );
};
  ...
  return /* @__PURE__ */ jsx(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
        ...
        /* @__PURE__ */ jsx(Grid.Root, { gap: 5, children: [
          {
            hint: formatMessage({
...
export { ProfilePage };
//# sourceMappingURL=ProfilePage-BII5JCBT.mjs.map
