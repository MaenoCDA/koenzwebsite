...
import { GitHub, GlassesSquare } from '@strapi/icons/symbols';
import { useIntl } from 'react-intl';
import { y as StrapiLogo, t as useClipboard, b as Layouts, P as Pagination, v as ContentBox } from './index-Ci1UPn5H.mjs';
import { c as useTracking, a as useNotification, P as Page, b as useTypedSelector, n as useQueryParams, p as useAppInfo } from './Theme-BneL-jOW.mjs';
...
const NpmPackagesGrid = ({
  ...
  if (npmPackages.length === 0) {
    return /* @__PURE__ */ jsxs(Box, { position: "relative", children: [
      ...
      /* @__PURE__ */ jsx(Box, { position: "absolute", top: 11, width: "100%", children: /* @__PURE__ */ jsx(Flex, { alignItems: "center", justifyContent: "center", direction: "column", children: /* @__PURE__ */ jsx(Box, { paddingTop: 6, children: /* @__PURE__ */ jsx(Typography, { variant: "delta", tag: "p", textColor: "neutral600", children: emptySearchMessage }) }) }) })
    ] });
  }
...
//# sourceMappingURL=MarketplacePage-B-9bz6Qt.mjs.map
