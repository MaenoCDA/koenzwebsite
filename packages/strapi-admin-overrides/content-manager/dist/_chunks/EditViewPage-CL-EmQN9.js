...
const Field = require("./Field-3FcGlfLA.js");
...
const react_1 = React__namespace.default;
...
(function(exports2) {
  ...
  const react_12 = __importDefault2(React__namespace.default);
  ...
  function Sticky2(props) {
    const _a = Object.assign(Object.assign({}, exports2.defaultProps), props), {
...
const EditViewPage = () => {
  ...
  const initialValues = React__namespace.useMemo(() => {
    ...
    const form = document2?.id ? document2 : Field.createDefaultForm(schema, components);
        ...
        children: ({ resetForm }) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tabs.Root, { variant: "simple", value: status, onValueChange: handleTabChange, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { paddingTop: 8, gap: 4, children: [
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Item, { col: 10, m: 9, s: 12, direction: "column", alignItems: "stretch", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 2, m: 3, s: 12, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsxRuntime.jsx(_default, { children: /* @__PURE__ */ jsxRuntime.jsx(index.Panels, {}) }) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(
            strapiAdmin.Blocker,
...
//# sourceMappingURL=EditViewPage-CL-EmQN9.js.map
