...
const Relations = require("./Relations-DzrZ2GTJ.js");
...
const LeftMenu = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SubNav, { "aria-label": label, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(index.InjectionZone, { area: "menu.left-menu", props: { schemas, getPluginsParamsForLink } })
  ] });
};
...
//# sourceMappingURL=layout-BsCiBsmN.js.map
