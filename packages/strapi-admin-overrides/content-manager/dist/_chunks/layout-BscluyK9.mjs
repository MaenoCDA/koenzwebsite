...
import { Box, Flex, Typography, IconButton, useFilter, useCollator, SubNav, SubNavHeader, useNotifyAT } from "@strapi/design-system";
...
import { D as DocumentStatus, u as useContentTypeSchema, g as getTranslation, I as InjectionZone, a as useGetInitialDataQuery, b as useGetAllContentTypeSettingsQuery, s as setInitialData, C as COLLECTION_TYPES, S as SINGLE_TYPES, H as HOOKS } from "./index-VGm9Nj3j.mjs";
import { F as FlexWrapper, L as LinkEllipsis, D as DisconnectButton } from "./Relations-CdwpXmkU.mjs";
...
const LeftMenu = () => {
  ...
  return /* @__PURE__ */ jsxs(SubNav, { "aria-label": label, children: [
    ...
    /* @__PURE__ */ jsx(InjectionZone, { area: "menu.left-menu", props: { schemas, getPluginsParamsForLink } })
  ] });
};
...
//# sourceMappingURL=layout-BscluyK9.mjs.map
