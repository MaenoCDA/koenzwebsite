...
const ProtectedHistoryPage = React.lazy(
  () => import("./History-DRf9-KIa.mjs").then((mod) => ({ default: mod.ProtectedHistoryPage }))
);
const routes$2 = [
  {
...
const ProtectedPreviewPage = React.lazy(
  () => import("./Preview-CuiYQ40N.mjs").then((mod) => ({ default: mod.ProtectedPreviewPage }))
);
const routes$1 = [
  {
...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-D9xl1g8t.mjs").then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-_Ng0C8BK.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
const ProtectedListConfiguration = lazy(
  () => import("./ListConfigurationPage-CHqKA9r9.mjs").then((mod) => ({
    default: mod.ProtectedListConfiguration
  }))
);
const ProtectedEditConfigurationPage = lazy(
  () => import("./EditConfigurationPage-SVVXidFp.mjs").then((mod) => ({
    default: mod.ProtectedEditConfigurationPage
  }))
);
const ProtectedComponentConfigurationPage = lazy(
  () => import("./ComponentConfigurationPage-BXrdo3S0.mjs").then((mod) => ({
    default: mod.ProtectedComponentConfigurationPage
  }))
);
const NoPermissions = lazy(
  () => import("./NoPermissionsPage-BzDo8WPv.mjs").then((mod) => ({ default: mod.NoPermissions }))
);
const NoContentType = lazy(
  () => import("./NoContentTypePage-DMCJ9Ejj.mjs").then((mod) => ({ default: mod.NoContentType }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-BscluyK9.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-VGm9Nj3j.mjs.map
