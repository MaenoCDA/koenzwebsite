...
const ProtectedHistoryPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./History-Z7yHHiAm.js")).then((mod) => ({ default: mod.ProtectedHistoryPage }))
);
const routes$2 = [
  {
...
const ProtectedPreviewPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./Preview-0s4aW_kW.js")).then((mod) => ({ default: mod.ProtectedPreviewPage }))
);
const routes$1 = [
  {
...
const ProtectedEditViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./EditViewPage-CL-EmQN9.js")).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListViewPage-Durk2aju.js")).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
const ProtectedListConfiguration = React.lazy(
  () => Promise.resolve().then(() => require("./ListConfigurationPage-21Z6y6EB.js")).then((mod) => ({
    default: mod.ProtectedListConfiguration
  }))
);
const ProtectedEditConfigurationPage = React.lazy(
  () => Promise.resolve().then(() => require("./EditConfigurationPage-D8eD3gaT.js")).then((mod) => ({
    default: mod.ProtectedEditConfigurationPage
  }))
);
const ProtectedComponentConfigurationPage = React.lazy(
  () => Promise.resolve().then(() => require("./ComponentConfigurationPage-BKB--1_x.js")).then((mod) => ({
    default: mod.ProtectedComponentConfigurationPage
  }))
);
const NoPermissions = React.lazy(
  () => Promise.resolve().then(() => require("./NoPermissionsPage-CmXLGE1f.js")).then((mod) => ({ default: mod.NoPermissions }))
);
const NoContentType = React.lazy(
  () => Promise.resolve().then(() => require("./NoContentTypePage-BTTWc4_5.js")).then((mod) => ({ default: mod.NoContentType }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await Promise.resolve().then(() => require("./layout-BsCiBsmN.js"));
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-2_ZRiInG.js.map
