...
const PluginIcon = () => /* @__PURE__ */ jsxs("svg", { fill: "#000000", viewBox: "-6.5 0 32 32", version: "1.1", xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  /* @__PURE__ */ jsxs("g", { id: "SVGRepo_iconCarrier", children: [
    /* @__PURE__ */ jsx("title", { children: "dropdown" }),
    /* @__PURE__ */ jsx("path", { d: "M18.813 11.406l-7.906 9.906c-0.75 0.906-1.906 0.906-2.625 0l-7.906-9.906c-0.75-0.938-0.375-1.656 0.781-1.656h16.875c1.188 0 1.531 0.719 0.781 1.656z" }),
    " "
  ] })
] });
const index = {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-Byx4XI2L.mjs"), "./translations/nl.json": () => import("./nl-WYhxQjQn.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
