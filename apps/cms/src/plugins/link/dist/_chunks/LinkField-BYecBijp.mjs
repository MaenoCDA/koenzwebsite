...
import { Box, Grid, Flex, Typography, Field, Combobox, ComboboxOption, Badge, SingleSelect, SingleSelectOption, TextInput } from "@strapi/design-system";
import { useState, useEffect, useCallback } from "react";
import { useIntl } from "react-intl";
import { P as PLUGIN_ID } from "./index-khgJPum0.mjs";
...
const LinkField = ({
  ...
  if (attribute.options?.format === "path") {
    return /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsxs(Grid.Root, { children: [
      /* @__PURE__ */ jsx(Grid.Item, { col: 12, paddingBottom: 2, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "flex-start", gap: 2, children: [
        /* @__PURE__ */ jsx(Typography, { variant: "pi", fontWeight: "bold", children: fieldLabel }),
        /* @__PURE__ */ jsx(Typography, { variant: "pi", children: fieldDescription })
      ] }) }),
            ...
            /* @__PURE__ */ jsx(
              Combobox,
              {
                ...
                children: routes && Object.entries(routes).map((localizedRoutes) => {
                  return localizedRoutes[1].map((route) => /* @__PURE__ */ jsx(
                    ComboboxOption,
                    {
  ...
  return /* @__PURE__ */ jsx(Flex, { spacing: 2, children: /* @__PURE__ */ jsxs(Box, { children: [
    /* @__PURE__ */ jsx(Grid.Root, { children: /* @__PURE__ */ jsx(Grid.Item, { col: 12, paddingBottom: 2, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "flex-start", gap: 2, children: [
      /* @__PURE__ */ jsx(Typography, { variant: "pi", fontWeight: "bold", children: fieldLabel }),
      /* @__PURE__ */ jsx(Typography, { variant: "pi", children: fieldDescription })
    ] }) }) }),
    /* @__PURE__ */ jsxs(Grid.Root, { gap: "2", style: { alignItems: "flex-start" }, children: [
      /* @__PURE__ */ jsx(Grid.Item, { col: 12, children: /* @__PURE__ */ jsxs(Flex, { gap: 4, direction: "row", alignItems: "flex-start", style: { width: "100%" }, children: [
        /* @__PURE__ */ jsxs(
          Field.Root,
          {
            error: Boolean(rawError),
            ...
            children: [
              /* @__PURE__ */ jsxs(
                SingleSelect,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(SingleSelectOption, { value: "internal", children: formatMessage({
                      id: getTranslation(`target.internal`)
                    }) }),
                    /* @__PURE__ */ jsx(SingleSelectOption, { value: "custom", children: formatMessage({
                      id: getTranslation(`target.custom`)
                    }) }),
                    /* @__PURE__ */ jsx(SingleSelectOption, { value: "external", children: formatMessage({
            ...
            children: [
              /* @__PURE__ */ jsxs(
                SingleSelect,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs(SingleSelectOption, { value: "self", children: [
                      " ",
                      formatMessage({
                        id: getTranslation(`target.self`)
                      })
                    ] }),
                    /* @__PURE__ */ jsx(SingleSelectOption, { value: "blank", children: formatMessage({
      ...
      /* @__PURE__ */ jsx(Grid.Item, { col: 12, m: 12, s: 12, children: value?.type === "internal" ? /* @__PURE__ */ jsxs(
        Field.Root,
        {
          error: Boolean(rawError),
          name: "link",
      ...
      ) : value?.type === "external" ? /* @__PURE__ */ jsxs(
        Field.Root,
        {
          error: Boolean(rawError),
          name: "link",
