...
const CustomItem = React.forwardRef(({ item, isOpacityEnabled, isDragging, style, ...props }, ref) => {
  const styles = {
...
const SortableListItem = ({ item, ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(CustomItem, { item, ref: setNodeRef, style: styles, isOpacityEnabled: isDragging, ...props, ...attributes, ...listeners });
};
...
const SortableList = ({ data, onShowMore, hasMore, settings, onSortEnd }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { maxWidth: "280px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { padding: 1, gap: 1, justifyContent: "space-between", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { size: "S", onClick: () => handleSubmit(), children: formatMessage({ id: getTranslation("plugin.settings.sortableList.save"), defaultMessage: "Save" }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { size: "S", disabled: hasMore ? true : false, onClick: onShowMore, children: formatMessage({ id: getTranslation("plugin.settings.sortableList.showMore") }) })
    ] })
  ] });
};
const SortMenu = ({ status, data, onSortEnd, onShowMore, hasMore, settings }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(React__namespace.default.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Popover.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover.Content, { onEscapeKeyDown: handleClose, onPointerDownOutside: handleClose, children: /* @__PURE__ */ jsxRuntime.jsx(SortableList, { data, onShowMore, onSortEnd, hasMore, settings }) })
  ] }) });
};
const SortModal = () => {
      ...
      [
        {
          ...
          id: "settings",
          to: `${PLUGIN_ID}`,
          Component: () => Promise.resolve().then(() => require("./Settings-BxRfliS2.js"))
        }
      ]
    );
    app.registerPlugin({
