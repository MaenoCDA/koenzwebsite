...
import { Box, Grid, Typography, Divider, Flex, Button, Popover, IconButton } from "@strapi/design-system";
...
function requireWithSelector_production() {
  ...
  var objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim2.useSyncExternalStore, useRef2 = React2.useRef, useEffect2 = React2.useEffect, useMemo = React2.useMemo, useDebugValue = React2.useDebugValue;
...
function requireWithSelector_development() {
  ...
  "production" !== process.env.NODE_ENV && function() {
    ...
    "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
    var React2 = React__default, shim2 = shimExports, objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim2.useSyncExternalStore, useRef2 = React2.useRef, useEffect2 = React2.useEffect, useMemo = React2.useMemo, useDebugValue = React2.useDebugValue;
...
const CustomItem = forwardRef(({ item, isOpacityEnabled, isDragging, style, ...props }, ref) => {
  const styles = {
...
const SortableListItem = ({ item, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(CustomItem, { item, ref: setNodeRef, style: styles, isOpacityEnabled: isDragging, ...props, ...attributes, ...listeners });
};
  ...
  try {
    if (subTitleField && entry[subTitleField]) {
      if (entry[subTitleField].constructor.name == "Array") {
        if (entry[subTitleField].length > 0) return ` - ${entry[subTitleField][0][titleField]}`;
...
const SortableList = ({ data, onShowMore, hasMore, settings, onSortEnd }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { maxWidth: "280px" }, children: [
    ...
    /* @__PURE__ */ jsxs(Flex, { padding: 1, gap: 1, justifyContent: "space-between", children: [
      /* @__PURE__ */ jsx(Button, { size: "S", onClick: () => handleSubmit(), children: formatMessage({ id: getTranslation("plugin.settings.sortableList.save"), defaultMessage: "Save" }) }),
      /* @__PURE__ */ jsx(Button, { size: "S", disabled: hasMore ? true : false, onClick: onShowMore, children: formatMessage({ id: getTranslation("plugin.settings.sortableList.showMore") }) })
    ] })
  ] });
};
const SortMenu = ({ status, data, onSortEnd, onShowMore, hasMore, settings }) => {
  ...
  return /* @__PURE__ */ jsx(React__default.Fragment, { children: /* @__PURE__ */ jsxs(Popover.Root, { children: [
    ...
    /* @__PURE__ */ jsx(Popover.Content, { onEscapeKeyDown: handleClose, onPointerDownOutside: handleClose, children: /* @__PURE__ */ jsx(SortableList, { data, onShowMore, onSortEnd, hasMore, settings }) })
  ] }) });
};
const SortModal = () => {
  ...
  const currentPage = params?.pageSize ? parseInt(params?.page) : 1;
  ...
  const refetchEntries = React__default.useCallback(() => dispatch(getData(uid, void 0)), [dispatch]);
  ...
  const fetchContentTypeConfig = async () => {
    try {
      const { data: data2 } = await get(`/content-manager/content-types/${contentTypePath}/configuration`);
      ...
      [
        {
          ...
          id: "settings",
          to: `${PLUGIN_ID}`,
          Component: () => import("./Settings-yJLuAy0-.mjs")
        }
      ]
    );
    app.registerPlugin({
