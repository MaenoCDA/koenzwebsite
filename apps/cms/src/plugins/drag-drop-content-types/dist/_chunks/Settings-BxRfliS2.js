...
const index$1 = require("./index-BYch1NdE.js");
...
const TooltipIconButton = ({ children, label, variant, onClick, disabled, showBorder = false }) => {
  ...
  const tooltipContent = showBorder ? /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 4, margin: 2, background: "neutral0", hasRadius: true, shadow: "filterShadow", children: [
...
const SettingsToggleField = (props) => {
  const { fieldName, displayName, required, value, updateItem, type, hasLabel = false, hasHint = false, hasTooltip = false } = props;
  const { formatMessage } = reactIntl.useIntl();
  const [hasError, setHasError] = React.useState(false);
  const onItemChange = (newValue) => {
    setHasError(required && !newValue);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      admin.Layouts.Header,
      {
        ...
        primaryAction: isLoading ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {}) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleSubmit, startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Check, {}), size: "L", disabled: isSaving || hasFormError, loading: isSaving, children: formatMessage({ id: index$1.getTranslation("plugin.settings.buttons.save") }) })
      }
    ),
    isLoading ? /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Loading, {}) : /* @__PURE__ */ jsxRuntime.jsx(admin.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", hasRadius: true, shadow: "filterShadow", paddingTop: 6, paddingBottom: 6, paddingLeft: 7, paddingRight: 7, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { size: 3, direction: "column", children: [
