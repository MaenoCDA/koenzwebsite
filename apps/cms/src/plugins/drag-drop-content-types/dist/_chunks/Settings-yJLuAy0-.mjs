...
import { g as getTranslation } from "./index-Cy0LBZhP.mjs";
...
const TooltipIconButton = ({ children, label, variant, onClick, disabled, showBorder = false }) => {
  ...
  const tooltipContent = showBorder ? /* @__PURE__ */ jsxs(Box, { padding: 4, margin: 2, background: "neutral0", hasRadius: true, shadow: "filterShadow", children: [
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsx(
      Layouts.Header,
      {
        ...
        primaryAction: isLoading ? /* @__PURE__ */ jsx(Fragment$1, {}) : /* @__PURE__ */ jsx(Button, { onClick: handleSubmit, startIcon: /* @__PURE__ */ jsx(Check, {}), size: "L", disabled: isSaving || hasFormError, loading: isSaving, children: formatMessage({ id: getTranslation("plugin.settings.buttons.save") }) })
      }
    ),
    isLoading ? /* @__PURE__ */ jsx(Page.Loading, {}) : /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsx(Box, { background: "neutral0", hasRadius: true, shadow: "filterShadow", paddingTop: 6, paddingBottom: 6, paddingLeft: 7, paddingRight: 7, children: /* @__PURE__ */ jsxs(Flex, { size: 3, direction: "column", children: [
