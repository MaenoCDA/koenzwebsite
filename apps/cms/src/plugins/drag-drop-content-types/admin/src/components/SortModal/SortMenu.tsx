	...
	return (
		<React.Fragment>
			<Popover.Root>
				...
				<Popover.Content onEscapeKeyDown={handleClose} onPointerDownOutside={handleClose}>
					<SortableList data={data} onShowMore={onShowMore} onSortEnd={onSortEnd} hasMore={hasMore} settings={settings} />
				</Popover.Content>
			</Popover.Root>
		</React.Fragment>
	);
