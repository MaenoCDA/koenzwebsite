...
import { Divider, Button, Flex } from '@strapi/design-system';
...
const SortableList = ({ data, onShowMore, hasMore, settings, onSortEnd }: SortableListProps) => {
	...
	return (
		<div style={{ maxWidth: '280px' }}>
			...
			<Divider margin={0} />
			<Flex padding={1} gap={1} justifyContent="space-between">
				<Button size="S" onClick={() => handleSubmit()}>
					{formatMessage({ id: getTrad('plugin.settings.sortableList.save'), defaultMessage: 'Save' })}
				</Button>
