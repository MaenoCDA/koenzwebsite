import{i2 as De,jt as Fe,ju as He,jf as Ge,jv as Ve,jw as We,jx as Ke,jy as Xe,jz as Ye,ji as ze,jg as qe,r as k,aF as Oe,aZ as P,gk as Z,af as U,j as t,cG as Ze,de as H,jA as oe,i4 as S,hK as R,jB as N,bj as O,cI as z,jC as $e,jD as Je,O as Qe,jE as he,b5 as y,b4 as E,cm as L,cX as ce,jF as Ue,jG as es,bb as B,bk as ge,J as T,bc as ss,bd as ts,au as ns,bp as ie,jH as os,cL as is,cK as rs,jI as as}from"./strapi-BzDuHlVM.js";import{g as re}from"./groupBy-B0lSKwdS.js";var ls=Ye,cs=We,ds=ze,us=Ge,ps=Xe,hs=qe,gs=Fe,fs=Ke,ms=Ve,xs=He;function Cs(e,s,o){var n=hs(e),r=n||gs(e)||xs(e);if(s=us(s),o==null){var a=e&&e.constructor;r?o=n?new a:[]:ms(e)?o=fs(a)?cs(ps(e)):{}:o={}}return(r?ls:ds)(e,function(c,i,l){return s(o,c,i,l)}),o}var js=Cs;const bs=De(js),[ys,ks]=Ze("PermissionsDataManager"),Y=()=>ks("usePermissionsDataManager");function fe(e,s){function o(n,r){return bs(n,(a,c,i)=>(Qe(c,r[i])||(a[i]=he(c)&&he(r[i])?o(c,r[i]):c),a))}return o(e,s)}const Te=e=>Array.isArray(e)?e.reduce((s,o)=>(Array.isArray(o)?s.push(...Te(o)):s.push(o),s),[]):[],G=e=>N(e)?Te(Object.values(e).map(s=>N(s)?G(s):s)):[],ve=(e,s,o)=>e.find(n=>n.action===s&&n.subject===o),Ss=e=>{const s=me(e.plugins),o=me(e.settings),n=xe(e.collectionTypes),r=xe(e.singleTypes);return[...s,...o,...n,...r]},me=e=>Object.values(e).reduce((s,o)=>{const n=Object.values(o).reduce((r,a)=>{const c=Object.entries(a).reduce((i,[l,{conditions:d,properties:{enabled:u}}])=>(u&&i.push({action:l,subject:null,conditions:ae(d),properties:{}}),i),[]);return[...r,...c]},[]);return[...s,...n]},[]),xe=e=>Object.entries(e).reduce((o,n)=>{const[r,a]=n,c=Object.entries(a).reduce((i,l)=>{const[d,u]=l;if(!G(u).some(h=>h))return i;if(!u?.properties?.enabled){const h=Object.entries(u.properties).reduce((C,m)=>{const[p,f]=m;return C.properties[p]=Me(f),C},{action:d,subject:r,conditions:ae(u.conditions),properties:{}});return[...i,h]}return u.properties.enabled&&i.push({action:d,subject:r,properties:{},conditions:ae(u.conditions)}),i},[]);return[...o,...c]},[]),Me=(e,s="")=>Object.entries(e).reduce((o,n)=>{const[r,a]=n;return N(a)?[...o,...Me(a,`${s}${r}.`)]:(a&&!N(a)&&o.push(`${s}${r}`),o)},[]),ae=e=>Object.entries(e).filter(([,s])=>s).map(([s])=>s),we=(e,s=[])=>e.reduce((o,n)=>(o[n.id]=s.indexOf(n.id)!==-1,o),{}),Ce=(e,s,o=[])=>e.reduce((n,{categoryId:r,childrenForm:a})=>{const c=a.reduce((i,l)=>(i[l.subCategoryId]=l.actions.reduce((d,u)=>{const g=ve(o,u.action,null);return d[u.action]={properties:{enabled:g!==void 0},conditions:we(s,g?.conditions??[])},d},{}),i),{});return n[r]=c,n},{}),As=(e,s,o)=>{const n=({children:r=[]},a,c="")=>r.reduce((i,l)=>{if(l.children)return{...i,[l.value]:n(l,a,`${c}${l.value}.`)};const d=a.indexOf(`${c}${l.value}`)!==-1;return i[l.value]=d,i},{});return e.reduce((r,a)=>{const c=s.properties.find(({value:i})=>i===a);if(c){const i=o?.properties[c.value]??[],l=n(c,i);r.properties[a]=l}return r},{properties:{}})},je=({subjects:e,actions:s=[]},o,n=[])=>s.reduce((r,a)=>{const c=a.subjects.reduce((l,d)=>{const u=e.find(({uid:g})=>g===d)||null;return u&&(l[d]=u),l},{});if(Z(c))return r;const i=Object.keys(c).reduce((l,d)=>{const{actionId:u,applyToProperties:g}=a,m=c[d].properties.map(({value:x})=>x).every(x=>(g||[]).indexOf(x)===-1),p=ve(n,u,d),f=we(o,p?.conditions??[]);if(l[d]||(l[d]={}),Z(g)||m)return l[d][u]={properties:{enabled:p!==void 0},conditions:f},l;const j=As(g,c[d],p);return l[d][u]={...j,conditions:f},l},{});return Je(r,i)},{}),be=(e,s)=>Object.entries(re(e,s)).map(([o,n])=>({category:o,categoryId:o.split(" ").join("-"),childrenForm:Object.entries(re(n,"subCategory")).map(([r,a])=>({subCategoryName:r,subCategoryId:r.split(" ").join("-"),actions:a}))})),Q=e=>Object.keys(e).reduce((s,o)=>{const n=e[o];if(N(n)&&!U(n,"conditions"))return{...s,[o]:Q(n)};if(N(n)&&U(n,"conditions")&&!G($e(n,"conditions")).some(a=>a)){const a=Object.keys(n.conditions).reduce((c,i)=>(c[i]=!1,c),{});return{...s,[o]:{...n,conditions:a}}}return s[o]=n,s},{}),q=(e,s,o=!1)=>Object.keys(e).reduce((n,r)=>{const a=e[r];return r==="conditions"&&!o?(n[r]=a,n):N(a)?{...n,[r]:q(a,s,r==="fields")}:(n[r]=s,n)},{}),I="12rem",de="20rem",se="5.3rem",ue=e=>e?Object.entries(e).reduce((s,[o,n])=>(o!=="conditions"&&(s[o]=n),s),{}):null,V=e=>{const s=ue(e),o=G(s);if(!o.length)return{hasAllActionsSelected:!1,hasSomeActionsSelected:!1};const n=o.every(a=>a),r=o.some(a=>a)&&!n;return{hasAllActionsSelected:n,hasSomeActionsSelected:r}},Pe=T(y)`
...
`,Is=k.forwardRef(({onClick:e,className:s,hasConditions:o=!1,variant:n="tertiary"},r)=>{const{formatMessage:a}=P();return t.jsx(Bs,{$hasConditions:o,className:s,children:t.jsx(ie,{variant:n,startIcon:t.jsx(rs,{}),onClick:e,ref:r,type:"button",children:a({id:"global.settings",defaultMessage:"Settings"})})})}),Bs=T(O)`
