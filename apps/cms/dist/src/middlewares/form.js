    ...
    const formattedSteps = form.steps.map((step) => {
        ...
        return {
            ...
            fields: layouts.lg.map((fieldLayout) => {
                ...
                const mdWidth = widthClassMap[(_a = layouts.md.find((f) => f.i === fieldLayout.i)) === null || _a === void 0 ? void 0 : _a.w] || 'col-span-full';
                const smWidth = widthClassMap[(_b = layouts.sm.find((f) => f.i === fieldLayout.i)) === null || _b === void 0 ? void 0 : _b.w] || 'col-span-full';
                return {
                    name: fieldData.name,
                    type: fieldData.type,
                    ...
                    validation: { required: (_c = fieldData.config) === null || _c === void 0 ? void 0 : _c.required },
                };
            }),
        };
    });
...
exports.default = TransformFormConfig;
